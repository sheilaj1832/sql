...
-- Add 'SYSTEM' user
INSERT INTO user (ID, UserName, Password, FirstName, LastName, Market, PhoneNumber, Email, IsReviewer, IsAdmin) VALUES 
(1,'sjohnson','apple9','Sheila','Johnson', 'Dallas','513-236-1832','sheilajohnson1832@gmail.com',1,1),
(2,'sblessing','login','Sean','Blessing', 'Cincinnati','513-600-7096','sean@blessingtechnology.com',1,1),
(3,'dcollins','innov8','Doug','Collins', 'Indianapolis','513-236-8564','doug_collins@me.com',1,1),
(4,'dinodeb','fossils','Deb','Smith', 'Columbus','513-555-1111','deb@trammelpark.org',1,1),
(5,'fiona1','bibirocks','Fiona','Hippo', 'Houston','513-281-4700','fiona@cincinnatizoo.ord',1,1),
(6,'jsprat','nofat','Jack','Sprat', 'Salt Lake City', '801-555-1111','jack_sprat@nurseryrhyme.com',1,1),
(7,'mickey1','ears','Mickey','Mouse', 'Paris', '708-555-5555','mickey@disney.com',1,1),
(8,'Simba','lion','Simba','King', 'Pasadena','513-777-0000','simba@king.com',1,1),
(9,'pinkalicious','pink','Pinkalicious','Peters', 'New York City','201-000-7465','pinkalicious@pbs.org',1,1),
(10,'barbie','majesty','Barbie','Smith', 'San Diego','312-555-0000','barbie@matteltoys.com',1,1);
